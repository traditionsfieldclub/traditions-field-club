      ...
      <div className="fixed bottom-6 right-6 z-50 md:hidden">
        ...
        {isOpen && (
          <div className="absolute bottom-16 right-0 mb-2 flex flex-col gap-3 items-end">
            ...
            <div
              className="flex items-center gap-3 bg-white text-[#162838]/50 pl-4 pr-3 py-3 rounded-full shadow-lg cursor-default"
            >
              <span className="text-sm font-medium whitespace-nowrap">Phone Coming Soon</span>
              <div className="w-10 h-10 bg-[#162838]/30 rounded-full flex items-center justify-center">
                <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
