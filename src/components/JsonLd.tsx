...
const localBusiness = {
  ...
  name: "Traditions Field Club",
  description:
    "A veteran-owned premier sporting clays club in South Carolina's Lowcountry. Family-friendly memberships, certified instruction, corporate events, and youth programs.",
  url: BASE_URL,
  image: [`${BASE_URL}/og-image.jpg`],
  logo: `${BASE_URL}/logo.png`,
  email: "info@traditionsfieldclub.com",
