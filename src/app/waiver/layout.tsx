...
export const metadata: Metadata = {
  ...
  description:
    "Complete the Traditions Field Club liability waiver and release form before your visit. Required for all participants in sporting clays and 5-stand activities.",
  openGraph: {
    title: "Sign Waiver — Liability Release Form",
    description:
      "Complete the Traditions Field Club liability waiver and release form before your visit. Required for all participants in sporting clays and 5-stand activities.",
